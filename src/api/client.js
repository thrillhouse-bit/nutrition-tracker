...
export const api = {
  ...
  startPasswordRecovery: (email) => req('/auth/recovery/start', { method: 'POST', body: JSON.stringify({ email }) }),
  resetPassword: (password, confirmation) => req('/auth/recovery/reset', { method: 'POST', body: JSON.stringify({ password, confirmation }) }),
