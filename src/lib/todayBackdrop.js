...
export const TODAY_BACKDROP_SCENES = Object.freeze([
  ...
  },
  {
    id: 'manhattan',
    label: 'Manhattan',
    description: 'Lower Manhattan and One World Trade Center after dark',
    credit: 'Radu Lin',
    sourceName: 'Unsplash',
    sourceUrl: 'https://unsplash.com/photos/a-city-skyline-at-night-WnKeRXeIAKk?utm_source=body_current&utm_medium=referral',
    licenseUrl: 'https://unsplash.com/license',
  },
  {
    id: 'big-sur',
