...
export const ACT4_RUNTIME_MAPS = deepFreeze({
  'slag-road': {
    ...
    entities: [
      ...
      { id: 'athena-march-captain', kind: 'npc', x: 410, y: 330, name: 'Athena', label: 'Hear the precise route', conversationId: 'act4-athena-precise-route' },
      { id: 'ares-march-captain', kind: 'npc', x: 456, y: 340, name: 'Ares', label: 'Hear the direct breach', conversationId: 'act4-ares-direct-breach' },
      ...
      { id: 'mortal-draft-table-voice', kind: 'npc', x: 500, y: 370, name: 'The Dawn Muster', label: 'Hear the assembled witnesses', conversationId: 'act4-mortal-draft' },
  ...
  'name-press': {
    ...
    entities: [
      ...
      { id: 'prometheus', kind: 'npc', x: 440, y: 362, name: 'Prometheus', label: 'Speak with Prometheus', conversationId: 'act4-prometheus-lawful-fire' },
  ...
  'atlas-vault': {
    ...
    entities: [
      ...
      { id: 'atlas-npc', kind: 'npc', x: 566, y: 342, name: 'Atlas', label: 'Speak with Atlas', identityRole: 'coerced-witness', conversationId: 'act4-atlas-coerced-witness' },
      { id: 'hercules', kind: 'npc', x: 600, y: 370, name: 'Hercules', label: 'Speak with Hercules', conversationId: 'act4-hercules-freely-given' },
      { id: 'smith-thais', kind: 'npc', x: 740, y: 340, name: 'Thais', label: 'Speak with the freed smiths', conversationId: 'act4-smiths-ledger' },
      { id: 'zeus-crown-herald', kind: 'npc', x: 860, y: 260, name: 'Herald of Zeus', label: 'Hear the single-crown offer', conversationId: 'act4-zeus-single-crown' },
