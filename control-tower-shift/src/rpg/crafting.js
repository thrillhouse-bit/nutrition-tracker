...
export const ITEM_EXTENSIONS = Object.freeze({
  ...
  'cypress-helm': {
    ...
    stackable: false,
    tier: 2,
    combatModifiers: Object.freeze({ accuracyBonus: 2, defenseBonus: 10, maxHealthBonus: 5 }),
  },
  'olive-circlet': {
    id: 'olive-circlet',
    name: 'Olive Circlet',
    ...
    stackable: false,
    tier: 1,
    combatModifiers: Object.freeze({ accuracyBonus: 1, defenseBonus: 3, maxHealthBonus: 1 }),
  },
  'laurel-war-crown': {
    id: 'laurel-war-crown',
    name: 'Laurel War-Crown',
    category: 'armor',
    equipmentSlot: 'head',
    stackable: false,
    tier: 3,
    combatModifiers: Object.freeze({ accuracyBonus: 3, defenseBonus: 16, maxHealthBonus: 9 }),
  },
  'bronze-dory': {
    id: 'bronze-dory',
    name: 'Bronze Dory',
    ...
    stackable: false,
    tier: 2,
    combatModifiers: Object.freeze({ accuracyBonus: 7, damageBonus: 10 }),
  },
  'laurel-oath-spear': {
    id: 'laurel-oath-spear',
    name: 'Laurel Oath-Spear',
    category: 'weapon',
    equipmentSlot: 'weapon',
    stackable: false,
    tier: 3,
    combatModifiers: Object.freeze({ accuracyBonus: 12, damageBonus: 17 }),
  },
  'linen-cuirass': {
    id: 'linen-cuirass',
    name: 'Linen Cuirass',
    ...
    stackable: false,
    tier: 2,
    combatModifiers: Object.freeze({ defenseBonus: 8, maxHealthBonus: 10 }),
  },
  'bronze-scale-cuirass': {
    ...
    stackable: false,
    tier: 3,
    combatModifiers: Object.freeze({ defenseBonus: 15, maxHealthBonus: 20 }),
  },
  'olive-buckler': {
    id: 'olive-buckler',
    name: 'Olive Buckler',
    ...
    stackable: false,
    tier: 1,
    combatModifiers: Object.freeze({ defenseBonus: 4, maxHealthBonus: 2 }),
  },
  'bronze-aspis': {
    id: 'bronze-aspis',
    name: 'Bronze Aspis',
    ...
    stackable: false,
    tier: 2,
    combatModifiers: Object.freeze({ defenseBonus: 9, maxHealthBonus: 6 }),
  },
  'laurel-aegis': {
    id: 'laurel-aegis',
    name: 'Laurel Aegis',
    ...
    stackable: false,
    tier: 3,
    combatModifiers: Object.freeze({ defenseBonus: 17, maxHealthBonus: 12 }),
  },
  'woven-greaves': {
    id: 'woven-greaves',
    name: 'Woven Greaves',
    ...
    stackable: false,
    tier: 1,
    combatModifiers: Object.freeze({ defenseBonus: 3, maxHealthBonus: 3 }),
  },
  'bronze-greaves': {
    id: 'bronze-greaves',
    name: 'Bronze Greaves',
    ...
    stackable: false,
    tier: 2,
    combatModifiers: Object.freeze({ defenseBonus: 7, maxHealthBonus: 6 }),
  },
  'laurel-greaves': {
    id: 'laurel-greaves',
    name: 'Laurel Greaves',
    ...
    stackable: false,
    tier: 3,
    combatModifiers: Object.freeze({ defenseBonus: 13, maxHealthBonus: 11 }),
  },
  'olive-sandals': {
    id: 'olive-sandals',
    ...
    stackable: false,
    tier: 1,
    combatModifiers: Object.freeze({ accuracyBonus: 1, defenseBonus: 1 }),
  },
  'cypress-trail-boots': {
    id: 'cypress-trail-boots',
    name: 'Cypress Trail Boots',
    category: 'armor',
    equipmentSlot: 'feet',
    stackable: false,
    tier: 2,
    combatModifiers: Object.freeze({ accuracyBonus: 3, defenseBonus: 4, maxHealthBonus: 2 }),
  },
  'bronze-bound-boots': {
    id: 'bronze-bound-boots',
    name: 'Bronze-Bound Boots',
    category: 'armor',
    equipmentSlot: 'feet',
    stackable: false,
    tier: 3,
    combatModifiers: Object.freeze({ accuracyBonus: 6, defenseBonus: 8, maxHealthBonus: 5 }),
  },
  'olive-figurehead': {
    id: 'olive-figurehead',
  ...
  'iron-quarry-pick': {
    ...
    stackable: false,
    tier: 2,
    toolBonus: Object.freeze({ skillId: 'quarrying', yieldBonus: 2 }),
  },
  'iron-herb-sickle': {
    id: 'iron-herb-sickle',
  ...
  'bronze-fishing-rod': {
    ...
    stackable: false,
    tier: 1,
    toolBonus: Object.freeze({ skillId: 'fishing', yieldBonus: 1 }),
  },
  'iron-fishing-rod': {
    id: 'iron-fishing-rod',
    ...
    stackable: false,
    tier: 2,
    toolBonus: Object.freeze({ skillId: 'fishing', yieldBonus: 2 }),
  },
  'bronze-hoe': {
    id: 'bronze-hoe',
    name: 'Bronze Hoe',
    ...
    stackable: false,
    tier: 1,
    toolBonus: Object.freeze({ skillId: 'stewardship', yieldBonus: 1 }),
  },
  'iron-hoe': {
    id: 'iron-hoe',
    name: 'Iron Hoe',
...
const RECIPE_DEFS = [
  ...
  Object.freeze({
    id: 'bronze-dory',
    name: 'Forge Bronze Dory',
    skillId: 'bronzework',
    stationId: 'bronze-forge',
    level: 12,
    xp: 72,
    ingredients: [
      { itemId: 'bronze-ingot', quantity: 1 },
      { itemId: 'olive-plank', quantity: 1 },
    ],
    outputs: [{ itemId: 'bronze-dory', quantity: 1 }],
  }),
  Object.freeze({
    id: 'iron-quarry-pick',
  ...
  Object.freeze({
    id: 'bronze-aspis',
    name: 'Forge Bronze Aspis',
    skillId: 'bronzework',
    stationId: 'bronze-forge',
    level: 26,
    xp: 165,
    ingredients: [
      { itemId: 'bronze-ingot', quantity: 2 },
      { itemId: 'cypress-plank', quantity: 1 },
    ],
    outputs: [{ itemId: 'bronze-aspis', quantity: 1 }],
  }),
  Object.freeze({
    id: 'bronze-greaves',
    ...
    ingredients: [
      { itemId: 'bronze-ingot', quantity: 2 },
      { itemId: 'linen-weave', quantity: 1 },
    ],
    outputs: [{ itemId: 'bronze-greaves', quantity: 1 }],
  }),
  Object.freeze({
    id: 'bronze-bound-boots',
    name: 'Forge Bronze-Bound Boots',
    skillId: 'bronzework',
    stationId: 'bronze-forge',
    level: 30,
    xp: 195,
    ingredients: [
      { itemId: 'bronze-fittings', quantity: 2 },
      { itemId: 'linen-weave', quantity: 1 },
    ],
    outputs: [{ itemId: 'bronze-bound-boots', quantity: 1 }],
  }),
  Object.freeze({
    id: 'bronze-scale-cuirass',
    name: 'Forge Bronze-Scale Cuirass',
    skillId: 'bronzework',
    stationId: 'bronze-forge',
    level: 36,
    xp: 230,
    ingredients: [
      { itemId: 'bronze-ingot', quantity: 3 },
      { itemId: 'linen-weave', quantity: 1 },
    ],
    outputs: [{ itemId: 'bronze-scale-cuirass', quantity: 1 }],
  }),
  Object.freeze({
    id: 'laurel-oath-spear',
    name: 'Forge Laurel Oath-Spear',
    skillId: 'bronzework',
    stationId: 'bronze-forge',
    level: 38,
    xp: 260,
    ingredients: [
      { itemId: 'bronze-ingot', quantity: 2 },
      { itemId: 'laurel-branch', quantity: 2 },
      { itemId: 'sage-thread', quantity: 1 },
    ],
    outputs: [{ itemId: 'laurel-oath-spear', quantity: 1 }],
  }),
  Object.freeze({
    id: 'laurel-aegis',
    name: 'Forge Laurel Aegis',
    skillId: 'bronzework',
    stationId: 'bronze-forge',
    level: 42,
    xp: 310,
    ...
    outputs: [{ itemId: 'laurel-aegis', quantity: 1 }],
  }),
  ...
  Object.freeze({
    id: 'olive-circlet',
    name: 'Carve Olive Circlet',
    skillId: 'carpentry',
    stationId: 'woodwork-bench',
    level: 3,
    xp: 24,
    ingredients: [{ itemId: 'olive-plank', quantity: 1 }],
    outputs: [{ itemId: 'olive-circlet', quantity: 1 }],
  }),
  Object.freeze({
    id: 'olive-buckler',
    name: 'Join Olive Buckler',
    skillId: 'carpentry',
    stationId: 'woodwork-bench',
    level: 6,
    xp: 38,
    ingredients: [
      { itemId: 'olive-plank', quantity: 2 },
      { itemId: 'bronze-fittings', quantity: 1 },
    ],
    outputs: [{ itemId: 'olive-buckler', quantity: 1 }],
  }),
  Object.freeze({
    id: 'cypress-plank',
  ...
  Object.freeze({
    id: 'cypress-trail-boots',
    name: 'Shape Cypress Trail Boots',
    skillId: 'carpentry',
    stationId: 'woodwork-bench',
    level: 18,
    xp: 92,
    ...
    outputs: [{ itemId: 'cypress-trail-boots', quantity: 1 }],
  }),
  Object.freeze({
    id: 'cedar-keel',
  ...
  Object.freeze({
    id: 'olive-sandals',
    name: 'Weave Olive-Strap Sandals',
    skillId: 'weaving',
    stationId: 'loom',
    level: 4,
    xp: 24,
    ingredients: [
      { itemId: 'flax-fiber', quantity: 2 },
      { itemId: 'olive-plank', quantity: 1 },
    ],
    outputs: [{ itemId: 'olive-sandals', quantity: 1 }],
  }),
  Object.freeze({
    id: 'woven-greaves',
    name: 'Weave Field Greaves',
    skillId: 'weaving',
    stationId: 'loom',
    level: 7,
    xp: 36,
    ingredients: [{ itemId: 'flax-fiber', quantity: 4 }],
    outputs: [{ itemId: 'woven-greaves', quantity: 1 }],
  }),
  Object.freeze({
    id: 'undyed-cloth',
  ...
  Object.freeze({
    id: 'linen-cuirass',
    name: 'Weave Linen Cuirass',
    skillId: 'weaving',
    stationId: 'loom',
    level: 28,
    xp: 125,
    ingredients: [{ itemId: 'linen-weave', quantity: 2 }],
    outputs: [{ itemId: 'linen-cuirass', quantity: 1 }],
  }),
  Object.freeze({
    id: 'laurel-loom-fiber',
  ...
  Object.freeze({
    id: 'laurel-war-crown',
    name: 'Weave Laurel War-Crown',
    skillId: 'weaving',
    stationId: 'loom',
    level: 42,
    xp: 240,
    ingredients: [
      { itemId: 'laurel-loom-fiber', quantity: 1 },
      { itemId: 'bronze-fittings', quantity: 1 },
    ],
    outputs: [{ itemId: 'laurel-war-crown', quantity: 1 }],
  }),
  Object.freeze({
    id: 'laurel-greaves',
    name: 'Weave Laurel Greaves',
    skillId: 'weaving',
    stationId: 'loom',
    level: 44,
    xp: 270,
    ...
    outputs: [{ itemId: 'laurel-greaves', quantity: 1 }],
  }),
